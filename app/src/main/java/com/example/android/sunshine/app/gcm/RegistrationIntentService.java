...
public class RegistrationIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            // In the (unlikely) event that multiple refresh options occur simultaneously,
            ...
            synchronized (TAG){
                ...
                // sent to your server. If boolean is false, send the token to your server,
            ...
            // on third party server, this ensure that we'll attempt the update at a later time.

...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        // longitude, in case we are syncing based on new Place Picker API result.
        ...
        try {
            ...
            if (Utility.isLocationAvailable(context)){
    ...
    private void updateWidgets(){
        Context context = getContext();
        // Setting the package ensures that only components in our app will receive the broadcasr
    ...
    private void updateMuzei(){
        ...
        // Muzei background on lower API devices
